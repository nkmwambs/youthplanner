<div id="popover_add_task" class="hidden">
    ...
    <div class="popover-body">
    	<?php 
			 echo form_open(base_url() . 'index.php?coach/add_task/', array('id'=>'frm_add_task','class' => 'form-horizontal validate','enctype' => 'multipart/form-data'));
		...
		?>   
			...
			<div class="form-group">
				<div class="col-xs-12" style="text-align: center;">
					<button class="btn btn-default" onclick="add_new_task();" id="save_task">
						<i class="fa fa-plus"></i>
						<span><?php echo get_phrase('save_task'); ?></span>
					</button>
			...
			<div  class="form-group">
				<label for="" class="col-xs-12" style="text-align: center;"><?php echo get_phrase('click_add_task_button_to_exit');?></label>
